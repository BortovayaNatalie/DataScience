...
# программы завершается. Если специальный символ введен п
# осле нескольких чисел, то вначале нужно добавить сумму
# этих чисел к полученной ранее сумме и после этого
# завершить программу.
...
def my_sum ():
    ...
    ex = False
    while ex == False:
        number = input('Введите число или введите "q" для выхода').split()
        res = 0
        ...
        sum_res = sum_res + res
        print(f'Текущее значение суммы: {sum_res}')
    print(f'Окончательное значение сумы {sum_res}')
my_sum()